...
public class UserAddDto implements Serializable {
  ...
  @Schema(description = "User signup(registration) type.", example = "EMAIL")
  private SignupType signupType;

  @Length(max = MAX_EMAIL_LENGTH)
  @Schema(description = "Account used during user signup(registration). The value is email or mobile.",
      maxLength = MAX_EMAIL_LENGTH, example = "Jams@123@xcan.cloud")
  private String signupAccount;

  @Schema(description = "Whether or not system administrator flag.", defaultValue = "false", example = "false")
