...
public class AppOrgAuthRest {
  ...
  @Operation(description = "Query the authorized tenant list of application.", operationId = "app:auth:tenant:list")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the authorized user list of application.", operationId = "app:auth:user:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the authorized departments list of application.", operationId = "app:auth:dept:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the authorized groups list of application.", operationId = "app:auth:group:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the all global authorized policies of application.", operationId = "app:auth:global:all")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Check the authorized organization(Tenant/User/Department/Group) of application.", operationId = "app:auth:org:check")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the authorized application policies list of organization(Tenant/User/Department/Group).", operationId = "app:auth:policy:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the authorized application list of organization(Tenant/User/Department/Group).", operationId = "org:auth:app:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
  ...
  @Operation(description = "Check organization(Tenant/User/Department/Group) authorized application.", operationId = "org:auth:app:check")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Organization not found")
  })
  ...
  @OperationClient
  @PreAuthorize("@PPS.isOpClient()")
  @Operation(description = "Query the application unauthorized tenants.", operationId = "app:unauth:tenant:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the application unauthorized users.", operationId = "app:unauth:user:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the application unauthorized departments.", operationId = "app:unauth:department:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the application unauthorized groups.", operationId = "app:unauth:group:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Query the application unauthorized policies.", operationId = "app:unauth:policy:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Authorize the application policies to the users.", operationId = "app:user:policy:auth")
  @ApiResponses(value = {
  ...
  @Operation(description = "Authorize the application policies to the departments.", operationId = "app:dept:policy:auth")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Created successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Authorize the application policies to the groups.", operationId = "app:group:policy:auth")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Created successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Delete the authorized users of application.", operationId = "app:user:policy:auth:delete")
  @ApiResponses(value = {
  ...
  @Operation(description = "Delete the authorized departments of application.", operationId = "app:dept:policy:auth:delete")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Deleted successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
  ...
  @Operation(description = "Delete the authorized groups of application.", operationId = "app:group:policy:auth:delete")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Deleted successfully"),
      @ApiResponse(responseCode = "404", description = "App not found")
  })
