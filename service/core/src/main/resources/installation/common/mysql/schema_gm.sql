...
CREATE TABLE `dept_user` (
  ...
  `main_dept_flag` int(11) NOT NULL COMMENT '是否主部门',
  `dept_head_flag` int(11) NOT NULL DEFAULT '0' COMMENT '是否部门负责人：0-一般用户；1-部门负责人；',
...
CREATE TABLE `group0` (
  ...
  `enabled_flag` int(11) NOT NULL DEFAULT '1' COMMENT '是否启用',
  ...
  KEY `idx_summary_group` (`enabled_flag`,`source`,`created_date`) USING BTREE,
  KEY `idx_summary_tenant_group` (`tenant_id`,`enabled_flag`,`source`,`created_date`) USING BTREE,
...
CREATE TABLE `tenant` (
  ...
  `locked_flag` int(11) NOT NULL DEFAULT '0' COMMENT '锁定状态：0-未锁定；1-已锁定',
  ...
  KEY `idx_locked_flag` (`locked_flag`) USING BTREE,
  KEY `idx_lock_start_date` (`lock_start_date`) USING BTREE,
  KEY `idx_lock_end_date` (`lock_end_date`) USING BTREE,
  KEY `idx_summary_group` (`source`,`type`,`status`,`real_name_status`,`locked_flag`,`created_date`) USING BTREE,
...
CREATE TABLE `tenant_cert_audit` (
  ...
  `auto_audit_flag` int(11) NOT NULL COMMENT '是否自动审核标志',
  `created_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '创建人',
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '创建时间',
  `last_modified_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '最后修改人',
  `last_modified_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '最后修改时间',
...
CREATE TABLE `user0` (
  ...
  `fullname` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '全名',
  ...
  `signup_account` varchar(100) COLLATE utf8mb4_bin DEFAULT '' COMMENT '注册账号（手机号或邮箱）',
  `signup_device_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '设备ID',
  ...
  `dept_head_flag` int(11) DEFAULT '0' COMMENT '是否部门负责人：0-一般用户；1-部门负责人；',
  `sys_admin_flag` int(11) NOT NULL DEFAULT '0' COMMENT '是否系统管理员：0-一般用户；1-系统管理员；',
  `expired_flag` int(11) NOT NULL COMMENT '到期标记：0-未到期；1-已到期',
  `expired_date` datetime DEFAULT NULL COMMENT '到期时间',
  `enabled_flag` int(11) NOT NULL DEFAULT '0' COMMENT '用户状态：0-禁用；1-启用',
  ...
  `locked_flag` int(11) NOT NULL COMMENT '锁定状态：0-未锁定；1-已锁定',
  `last_lock_date` datetime DEFAULT NULL COMMENT '最后锁定时间',
  `lock_start_date` datetime DEFAULT NULL COMMENT '锁定开始时间',
  `lock_end_date` datetime DEFAULT NULL COMMENT '锁定结束时间',
  ...
  KEY `idx_admin_flag` (`sys_admin_flag`) USING BTREE,
  ...
  KEY `idx_summary_group` (`source`,`sys_admin_flag`,`enabled_flag`,`locked_flag`,`gender`,`created_date`) USING BTREE,
  KEY `idx_summary_tenant_group` (`tenant_id`,`source`,`sys_admin_flag`,`enabled_flag`,`locked_flag`,`gender`,`created_date`) USING BTREE,
  FULLTEXT KEY `fx_name_mobile_title_username` (`fullname`,`mobile`,`title`,`username`) /*!50100 WITH PARSER `ngram` */
...
CREATE TABLE `user_directory` (
  ...
  `enabled_flag` int(11) NOT NULL COMMENT '启用/禁用状态',
...
CREATE TABLE `api` (
  ...
  `enabled_flag` int(11) NOT NULL COMMENT '有效状态',
  ...
  `service_enabled_flag` int(11) DEFAULT NULL COMMENT '服务启用状态',
  `sync_flag` int(11) NOT NULL COMMENT '是否是同步',
  `swagger_deleted_flag` int(11) DEFAULT NULL COMMENT '同步删除状态',
  `created_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '创建人',
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '创建时间',
  `last_modified_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '最后修改人',
  `last_modified_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '最后修改时间',
  ...
  KEY `idx_summary_group` (`method`,`type`,`enabled_flag`,`created_date`) USING BTREE,
...
CREATE TABLE `app` (
  ...
  `auth_ctrl_flag` int(11) DEFAULT NULL COMMENT '授权控制标志态：0-不控制；1-控制',
  `enabled_flag` int(11) NOT NULL COMMENT '启用状态：0-禁用；1-启用',
  ...
  KEY `idx_tenant_id` (`tenant_id`) USING BTREE,
  KEY `idx_enabled_fl_id_sequence` (`enabled_flag`,`id`,`sequence`) USING BTREE,
...
CREATE TABLE `app_func` (
  ...
  `description` varchar(200) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '描述',
  `auth_ctrl_flag` int(11) NOT NULL COMMENT '授权控制标志态：0-不控制；1-控制',
  `enabled_flag` int(11) NOT NULL COMMENT '启用状态：0-禁用；1-启用',
  `url` varchar(200) COLLATE utf8mb4_bin NOT NULL COMMENT 'URL',
...
) ENGINE=InnoDB AUTO_INCREMENT=223470423323443232 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='应用功能关联表';
...
CREATE TABLE `app_open` (
  ...
  `expiration_deleted_flag` int(11) NOT NULL COMMENT '过期删除标志',
  `op_client_open_flag` int(11) NOT NULL COMMENT '运营端开通标志',
  `created_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_created_date` (`created_date`) USING BTREE,
  KEY `idx_expiration_date` (`expiration_date`) USING BTREE,
  KEY `idx_expiration_deleted_flag` (`expiration_deleted_flag`) USING BTREE,
  KEY `idx_op_client_open_flag` (`op_client_open_flag`) USING BTREE,
...
CREATE TABLE `auth_policy` (
  ...
  `enabled_flag` int(11) NOT NULL COMMENT '有效状态：0-禁用；1-启用',
  `type` varchar(20) COLLATE utf8mb4_bin NOT NULL DEFAULT '1' COMMENT '策略分类',
  `default_flag` int(11) NOT NULL COMMENT '默认权限策略',
...
CREATE TABLE `auth_policy_org` (
  ...
  `open_auth_flag` int(11) NOT NULL COMMENT '开通授权初始化标志',
  `app_id` bigint(20) NOT NULL COMMENT '应用ID',
  `tenant_id` bigint(20) NOT NULL COMMENT '租户ID',
  `default_flag` int(11) NOT NULL COMMENT '租户用户默认策略标识',
  `created_by` bigint(20) NOT NULL COMMENT '创建人',
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_tenant_id` (`tenant_id`) USING BTREE,
  ...
  KEY `idx_default_flag` (`default_flag`) USING BTREE,
  KEY `idx_open_auth_flag` (`open_auth_flag`) USING BTREE,
...
CREATE TABLE `auth_user` (
  ...
  `passd_expired_flag` int(11) NOT NULL COMMENT '密码到期标记：0-未到期；1-已到期',
  ...
  KEY `idx_passd_expired_flag` (`passd_expired_flag`) USING BTREE
...
CREATE TABLE `authority` (
  ...
  `source_enabled_flag` int(11) NOT NULL COMMENT '来源启用状态',
  `app_id` bigint(20) DEFAULT NULL COMMENT '应用ID',
  `app_enabled_flag` int(11) DEFAULT NULL COMMENT '应用启用状态',
  `api_id` bigint(20) NOT NULL COMMENT '接口ID',
  `api_code` varchar(80) COLLATE utf8mb4_bin NOT NULL COMMENT '接口编码',
  `api_enabled_flag` int(11) NOT NULL COMMENT '接口启用状态',
  ...
  KEY `idx_service_code` (`service_code`) USING BTREE,
  KEY `idx_source` (`source`) USING BTREE,
  KEY `idx_api_enabled_flag` (`api_enabled_flag`) USING BTREE,
  KEY `idx_service_enabled_flag` (`service_enabled_flag`) USING BTREE,
  KEY `idx_service_id` (`service_id`) USING BTREE,
  KEY `idx_app_id` (`app_id`) USING BTREE,
  KEY `idx_app_enabled_flag` (`app_enabled_flag`) USING BTREE,
  KEY `idx_source_enabled_flag` (`source_enabled_flag`) USING BTREE,
...
CREATE TABLE `client` (
  `id` bigint(20) NOT NULL COMMENT '主键ID',
  `name` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '名称',
  `platform` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '接入平台：XCAN_TP、XCAN_OP',
  `description` varchar(160) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '描述',
  `client_id` varchar(80) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT 'ID，对应KeyID',
  `client_secret` varchar(160) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '密码，对应KeySecret',
  `biz_tag` varchar(80) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '业务标识',
  `resource_ids` varchar(4000) COLLATE utf8mb4_bin DEFAULT '' COMMENT '能够访问的资源ID',
  `scopes` varchar(320) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT 'Scope授权',
  `authorized_grant_types` varchar(80) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '授权类型，可选值包括：authorization_code、password、refresh_token、implicit、client_credentials',
  `registered_redirect_uris` varchar(1000) COLLATE utf8mb4_bin DEFAULT '' COMMENT '注册转发地址',
  `authorities` varchar(4000) COLLATE utf8mb4_bin DEFAULT '' COMMENT '授权权限项',
  `auto_approve` int(11) NOT NULL DEFAULT '0' COMMENT '是否自动同意：1-需要用户同意；0-不需要用户同意',
  `auto_approve_scopes` varchar(320) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '自动同意scope',
  `additional_info` varchar(800) COLLATE utf8mb4_bin DEFAULT '' COMMENT '附加信息',
  `access_token_validity_seconds` int(20) NOT NULL DEFAULT '0' COMMENT '访问token有效期',
  `refresh_token_validity_seconds` int(20) NOT NULL DEFAULT '0' COMMENT '刷新token有效期',
  `tenant_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '租户ID，默认-1不限制接入租户',
  `tenant_name` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '租户名称',
  `enabled_flag` int(11) NOT NULL DEFAULT '1' COMMENT '启用标记：1-已启用；0-未启用',
...
CREATE TABLE `service` (
  ...
  KEY `idx_name` (`name`) USING BTREE,
  KEY `idx_summary_group` (`created_date`,`source`,`enabled_flag`) USING BTREE,
...
-- ----------------------------
-- Table structure for to_policy
-- ----------------------------
DROP TABLE IF EXISTS `to_policy`;
...
-- ----------------------------
-- Table structure for to_policy_user
-- ----------------------------
DROP TABLE IF EXISTS `to_policy_user`;
...
CREATE TABLE `api_log` (
  ...
  `fullname` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '访问用户名称',
  ...
  KEY `idx_success_flag` (`success`) USING BTREE,
...
CREATE TABLE `operation_log` (
  ...
  `code` varchar(80) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作编码',
  `tenant_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '租户ID',
  `tenant_name` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '租户名称',
  `user_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '用户ID',
  `fullname` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '用户名称',
  `description` varchar(50) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '操作描述',
  `success` int(11) NOT NULL COMMENT '成功标记：1-成功；0-失败',
  `failure_reason` varchar(200) COLLATE utf8mb4_bin DEFAULT '' COMMENT '失败原因',
  `request_id` varchar(40) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '请求ID',
  `opt_date` datetime DEFAULT '2001-01-01 00:00:00' COMMENT '操作时间',
  `resource_name` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作资源名称',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_success` (`success`) USING BTREE,
  KEY `idx_fullname` (`fullname`) USING BTREE,
  ...
  KEY `idx_summary_group` (`opt_date`,`success`) USING BTREE,
  KEY `idx_summary_tenant_group` (`tenant_id`,`opt_date`,`success`) USING BTREE
...
CREATE TABLE `message_sent` (
  ...
  `read_flag` int(11) NOT NULL DEFAULT '0' COMMENT '消息状态：0-未读；1-已读',
...
CREATE TABLE `notice` (
  ...
  `app_id` bigint(20) DEFAULT NULL COMMENT '应用ID',
  `app_code` varchar(40) COLLATE utf8mb4_bin DEFAULT '' COMMENT '应用编码',
  `app_name` varchar(20) COLLATE utf8mb4_bin DEFAULT '' COMMENT '应用名称',
  `edition_type` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '应用版本类型',
  `send_type` varchar(16) COLLATE utf8mb4_bin NOT NULL DEFAULT '1' COMMENT '发送方式：SEND_NOW-立即发送 ；TIMED_SEND-定时发送',
...
CREATE TABLE `event` (
  ...
  `fullname` varchar(100) COLLATE utf8mb4_bin DEFAULT '' COMMENT '用户名称',
...
CREATE TABLE `event_template` (
  ...
  `private_flag` int(11) NOT NULL COMMENT '是否私有化标志',
...
-- ----------------------------
-- Table structure for mcenter_online
-- ----------------------------
DROP TABLE IF EXISTS `mcenter_online`;
CREATE TABLE `mcenter_online` (
  ...
  `online_flag` int(11) NOT NULL COMMENT '是否在线：1-在线；0-未在线',
...
CREATE TABLE `id_config` (
  `pk` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `biz_key` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `format` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `prefix` varchar(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `date_format` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `seq_length` int NOT NULL,
  `mode` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `scope` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE `instance` (
  `pk` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `id` bigint NOT NULL,
  `host` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `port` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `instance_type` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `create_date` datetime NOT NULL,
  `last_modified_date` datetime NOT NULL,
  PRIMARY KEY (`pk`) USING BTREE,
...
CREATE TABLE `c_country` (
  ...
  `code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `chinese_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `iso2` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `iso3` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `abbr` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `open_flag` int NOT NULL DEFAULT '1' ,
...
CREATE TABLE `c_district` (
  ...
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `pin_yin` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `parent_code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `simple_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `level` int NOT NULL ,
  `country_code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `country_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `city_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `zip_code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `mer_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `lng` float NOT NULL ,
  `lat` float NOT NULL ,
  `geo` json DEFAULT NULL ,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `c_i18n_messages` (
  ...
  `language` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `default_message` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `i18n_message` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
...
CREATE TABLE `c_setting` (
  ...
  `value` varchar(16000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `global_default_flag` int NOT NULL ,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `c_setting_tenant` (
  ...
  `locale_data` json DEFAULT NULL COMMENT '租户国际化设置',
  `theme_data` json DEFAULT NULL COMMENT '租户外观设置',
  `func_data` json DEFAULT NULL COMMENT '租户平台默认功能指标',
  `perf_data` json DEFAULT NULL COMMENT '租户平台默认性能指标',
  `stability_data` json DEFAULT NULL COMMENT '租户平台默认稳定性指标',
  `security_data` json DEFAULT NULL COMMENT '租户账号安全设置',
  `server_api_proxy_data` json DEFAULT NULL COMMENT '服务端Api 代理配置',
  `tester_event_data` json DEFAULT NULL COMMENT 'AngusTeser事件通知类型配置',
  `tenant_id` bigint(20) NOT NULL COMMENT '租户ID',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `c_setting_tenant_quota` (
  ...
  `allow_change_flag` int(11) NOT NULL COMMENT '是否允许修改配额',
  `lcs_ctrl_flag` int(11) NOT NULL COMMENT 'LCS控制标识',
  `calc_remaining_flag` int(11) NOT NULL COMMENT '计算剩余配额标志',
  ...
  KEY `idx_allow_change_flag` (`allow_change_flag`) USING BTREE,
  KEY `idx_tenant_id` (`tenant_id`) USING BTREE,
  FULLTEXT KEY `fx_name` (`name`) /*!50100 WITH PARSER `ngram` */
...
CREATE TABLE `c_setting_user` (
  ...
  `api_proxy` json DEFAULT NULL ,
  `social_bind` json DEFAULT NULL ,
...
CREATE TABLE `email` (
  ...
  `verification_code_flag` int(11) NOT NULL,
  `verification_code_valid_second` int(11) DEFAULT '-1',
  `html_flag` int(11) NOT NULL,
  ...
  `urgent_flag` int(11) NOT NULL DEFAULT '0',
  `batch_flag` int(11) NOT NULL DEFAULT '0',
  ...
  `last_modified_by` bigint(21) NOT NULL DEFAULT '-1',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  KEY `idx_receive_object_type` (`receive_object_type`) USING BTREE,
  KEY `idx_summary_group` (`actual_send_date`,`send_status`,`urgent_flag`,`verification_code_flag`,`batch_flag`) USING BTREE
...
CREATE TABLE `email_server` (
  ...
  `protocol` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '',
  `enabled_flag` int NOT NULL,
  `host` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `port` int NOT NULL,
  `start_tls_enabled_flag` int NOT NULL,
  `ssl_enabled_flag` int NOT NULL,
  `auth_enabled_flag` int NOT NULL,
  `auth_account_data` json DEFAULT NULL,
  `subject_prefix` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `email_template` (
  `id` bigint NOT NULL ,
  `code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `language` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `subject` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `verification_code_flag` int NOT NULL ,
  `verification_code_valid_second` int DEFAULT '-1' ,
...
CREATE TABLE `email_template_biz` (
  `template_code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `biz_key` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' ,
  `private_flag` int DEFAULT NULL ,
...
CREATE TABLE `sms` (
  ...
  `verification_code_flag` int(11) NOT NULL COMMENT '是否验证码',
  `batch_flag` int(11) NOT NULL COMMENT '是否批量',
  `send_tenant_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '发送租户ID',
  `send_user_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '发送用户ID',
  `urgent_flag` int(11) NOT NULL DEFAULT '0' COMMENT '是否加急',
  ...
  KEY `idx_language` (`language`) USING BTREE,
  KEY `idx_verification_code_flag` (`verification_code_flag`) USING BTREE,
  KEY `idx_batch_flag` (`batch_flag`) USING BTREE,
  KEY `idx_send_user_id` (`send_user_id`) USING BTREE,
  KEY `idx_urgent_flag` (`urgent_flag`) USING BTREE,
  KEY `idx_summary_group` (`actual_send_date`,`send_status`,`urgent_flag`,`verification_code_flag`,`batch_flag`) USING BTREE
...
CREATE TABLE `sms_channel` (
  ...
  `enabled_flag` int(11) NOT NULL COMMENT '是否生效',
...
CREATE TABLE `sms_template` (
  ...
  `verification_code_flag` int(11) NOT NULL COMMENT '验证码标识',
  `verification_code_valid_second` int(11) DEFAULT '-1' COMMENT '验证码过期时间',
  `private_flag` int(1) NOT NULL DEFAULT '0' COMMENT '是否标志',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sms_template_biz` (
  ...
  `private_flag` int(11) NOT NULL COMMENT '是否私有化',
  PRIMARY KEY (`biz_key`) USING BTREE,
...
CREATE TABLE `bucket` (
  ...
  `tenant_created_flag` int(11) NOT NULL COMMENT '租户创建桶标识',
  `created_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '创建人',
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '创建时间',
  `last_modified_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '最后修改人',
  `last_modified_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '最后修改时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='对象桶';
...
CREATE TABLE `bucket_biz_config` (
  ...
  `public_access_flag` int(11) NOT NULL COMMENT '是否公开文件访问：公开访问文件（/pubapi）、私有访问文件（/api）',
  `public_token_auth_flag` int(11) NOT NULL COMMENT '公开令牌访问接口（私有访问文件也需要使用私有令牌认证）',
  `encrypt_flag` int(11) NOT NULL COMMENT '是否对文件加密存储',
  `multi_tenant_ctrl_flag` int(11) NOT NULL COMMENT '是否开启多租户控制(只针对下载时)',
  `enabled_auth_flag` int(11) NOT NULL COMMENT '开启空间认证标志',
  `allow_tenant_created_flag` int(11) NOT NULL COMMENT '允许租户业务创建桶标识',
  ...
  `private_flag` int(11) DEFAULT NULL COMMENT '是否私有化',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uidx_biz_key` (`biz_key`) USING BTREE,
  KEY `idx_bucket_name` (`bucket_name`) USING BTREE,
  KEY `idx_tenant_biz_flag` (`enabled_auth_flag`) USING BTREE
...
CREATE TABLE `object_file` (
  ...
  `complete_flag` int(11) DEFAULT '0' COMMENT '分片上传/断点续传是否上传完成标识',
  `store_deleted_flag` int(11) NOT NULL DEFAULT '0' COMMENT '存储文件删除状态',
  ...
  KEY `idx_store_deleted_flag` (`store_deleted_flag`) USING BTREE,
...
CREATE TABLE `object_space` (
  ...
  `customized_flag` int(11) NOT NULL COMMENT '是否客户化业务',
  `created_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '创建人',
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '创建时间',
  `last_modified_by` bigint(20) NOT NULL DEFAULT '-1' COMMENT '最后修改人',
  `last_modified_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '最后修改时间',
  ...
  KEY `idx_created_date` (`created_date`) USING BTREE,
  KEY `idx_bucket_name` (`bucket_name`) USING BTREE,
  KEY `idx_tenant_biz_flag` (`customized_flag`) USING BTREE,
...
CREATE TABLE `object_space_auth` (
  ...
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uidx_space_id_auth_creator_flag` (`space_id`,`auth_object_id`,`auth_object_type`,`creator_flag`) USING BTREE,
  KEY `idx_created_by` (`created_by`) USING BTREE,
  KEY `idx_tenant_id` (`tenant_id`) USING BTREE,
...
CREATE TABLE `object_space_object` (
  ...
  KEY `idx_level_size_sub_num` (`level`,`size`,`subdirectory_num`,`subfile_num`) USING BTREE,
  KEY `idx_store_type` (`store_type`) USING BTREE,
  KEY `idx_subdirectory_num` (`subdirectory_num`) USING BTREE,
  KEY `idx_subfile_num` (`subfile_num`) USING BTREE,
  KEY `idx_project_id` (`project_id`),
  FULLTEXT KEY `fx_name` (`name`) /*!50100 WITH PARSER `ngram` */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='对象文件元数据';
...
CREATE TABLE `object_space_share` (
  ...
  `all_flag` int(11) NOT NULL COMMENT '分享空间全部对象标志',
  ...
  `expired_flag` int(11) NOT NULL COMMENT '分享是否过期',
  ...
  `public_flag` int(11) NOT NULL COMMENT '公开或私有标志',
  `public_token` varchar(40) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '公开访问令牌',
  `passd` varchar(40) COLLATE utf8mb4_bin DEFAULT '' COMMENT '私有密码',
  `remark` varchar(200) COLLATE utf8mb4_bin DEFAULT '' COMMENT '备注',
  `tenant_id` bigint(20) NOT NULL DEFAULT '-1' COMMENT '租户ID',
  `created_by` bigint(20) NOT NULL COMMENT '创建人',
...
-- ----------------------------
-- Table structure for lcs
-- ----------------------------
DROP TABLE IF EXISTS `lcs`;
CREATE TABLE `lcs` (
  `id` bigint NOT NULL ,
  `main_flag` int NOT NULL DEFAULT '0' ,
  `lcs_no` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `main_lcs_no` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `issued_date` datetime NOT NULL ,
  `begin_date` datetime NOT NULL ,
  `end_date` datetime NOT NULL ,
  `info` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin ,
  `provider` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `issuer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `holder_id` bigint DEFAULT NULL ,
  `holder` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `goods_edition_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `goods_id` bigint DEFAULT NULL ,
  `goods_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `goods_code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `goods_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `goods_version` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `install_edition_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `signature` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `order_no` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `subject` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uidx_lcs_no` (`lcs_no`) USING BTREE,
  UNIQUE KEY `uidx_goods_edition_type` (`goods_code`,`goods_edition_type`) USING BTREE,
  UNIQUE KEY `uidx_goods_id` (`goods_id`) USING BTREE,
  KEY `idx_holder_id` (`holder_id`) USING BTREE,
  KEY `idx_issued_date` (`issued_date`) USING BTREE,
  KEY `idx_ begin_date` (`begin_date`) USING BTREE,
  KEY `idx_install_edition_type` (`install_edition_type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;

-- ----------------------------
-- Table structure for store_installation
-- ----------------------------
DROP TABLE IF EXISTS `store_installation`;
CREATE TABLE `store_installation` (
  `id` bigint NOT NULL ,
  `goods_id` bigint NOT NULL ,
  `edition_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `version` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `icon_text` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin ,
  `tags` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `introduction` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `information` varchar(6000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL ,
  `features` varchar(3200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL ,
  `charge_flag` int NOT NULL ,
  `order_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `purchase_by_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '-1' ,
  `purchase_date` datetime DEFAULT '2001-01-01 00:00:00' ,
  `platform` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `issuer` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `lcs_no` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `expired_date` datetime DEFAULT '2001-01-01 00:00:00' ,
  `server` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `apply_edition_type` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `apply_app_code` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `apply_version` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `downward_version` varchar(160) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `upgrade_from_goods_id` bigint DEFAULT '-1' ,
  `upgrade_from_code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '' ,
  `upgrade_from_version` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '' ,
  `install_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `install_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL ,
  `install_message` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `install_main_app_flag` int DEFAULT NULL ,
  `install_app_code` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `relative_install_paths` varchar(800) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `install_instance_id` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `online_install_flag` int DEFAULT NULL ,
  `uninstallable_flag` int DEFAULT NULL ,
  `uninstall_flag` int DEFAULT NULL ,
  `tenant_id` bigint NOT NULL ,
  `created_by` bigint DEFAULT '-1' ,
  `created_by_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL ,
  `created_date` datetime NOT NULL ,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_created_date` (`created_date`) USING BTREE,
  KEY `idx_edition_type` (`edition_type`) USING BTREE,
  KEY `idx_type` (`type`) USING BTREE,
  KEY `idx_install_type` (`install_type`) USING BTREE,
  KEY `idx_goods_id` (`goods_id`) USING BTREE,
  KEY `idx_install_status` (`install_status`) USING BTREE,
  KEY `idx_tenant_id` (`tenant_id`) USING BTREE,
  KEY `idx_upgrade_goods_id` (`upgrade_from_goods_id`) USING BTREE,
  KEY `dix_code_version_edition` (`code`,`version`,`edition_type`) USING BTREE,
  KEY `idx_platform` (`platform`) USING BTREE,
  KEY `idx_version` (`version`) USING BTREE,
  KEY `idx_summary_tenant_group` (`tenant_id`,`created_date`,`edition_type`,`type`,`charge_flag`,`install_type`,`install_status`) USING BTREE,
  KEY `idx_summary_group` (`created_date`,`edition_type`,`type`,`charge_flag`,`install_type`,`install_status`) USING BTREE,
  KEY `idx_uninstall_flag` (`uninstall_flag`) USING BTREE,
  KEY `idx_online_install_flag` (`online_install_flag`) USING BTREE,
  KEY `idx_uninstallable_flag` (`uninstallable_flag`) USING BTREE,
  KEY `idx_purchase_date` (`purchase_date`) USING BTREE,
  FULLTEXT KEY `fx_name_code_intro` (`name`,`code`,`introduction`) /*!50100 WITH PARSER `ngram` */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ;
