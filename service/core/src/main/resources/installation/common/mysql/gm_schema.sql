...
CREATE TABLE `auth_api_authority` (
  ...
  KEY `idx_api_enabled_flag` (`api_enabled`) USING BTREE,
  KEY `idx_service_enabled_flag` (`service_enabled`) USING BTREE,
  KEY `idx_service_id` (`service_id`) USING BTREE,
  KEY `idx_app_id` (`app_id`) USING BTREE,
  KEY `idx_app_enabled_flag` (`app_enabled`) USING BTREE,
  KEY `idx_source_enabled_flag` (`source_enabled`) USING BTREE,
...
CREATE TABLE `auth_policy_org` (
  ...
  KEY `idx_default_flag` (`default0`) USING BTREE,
  KEY `idx_open_auth_flag` (`open_auth`) USING BTREE,
...
CREATE TABLE `email_server` (
  ...
  `created_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00',
  `last_modified_by` bigint(20) NOT NULL DEFAULT '-1',
  `last_modified_date` datetime NOT NULL DEFAULT '2001-01-01 00:00:00',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `event_push` (
  ...
  KEY `idx_type` (`type`) USING BTREE,
  KEY `idx_push_flag` (`push`) USING BTREE,
...
CREATE TABLE `message_sent` (
  ...
  KEY `idx_created_date` (`created_date`) USING BTREE,
  KEY `idx_read_flag` (`read`) USING BTREE
...
CREATE TABLE `sms` (
  ...
  KEY `idx_language` (`language`) USING BTREE,
  KEY `idx_verification_code_flag` (`verification_code`) USING BTREE,
  KEY `idx_batch_flag` (`batch`) USING BTREE,
  KEY `idx_send_user_id` (`send_user_id`) USING BTREE,
  KEY `idx_urgent_flag` (`urgent`) USING BTREE,
  KEY `idx_summary_group` (`actual_send_date`,`send_status`,`urgent`,`verification_code`,`batch`) USING BTREE
