...
public class SystemLogRest {
  ...
  @Operation(summary = "Get all log file names for a service instance", operationId = "systemlog:instance:file:all")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Service instance log file names retrieved successfully")})
  ...
  @Operation(summary = "Get log file content with specified parameters", operationId = "systemlog:instance:file:detail")
  @ApiResponses(value = {
  ...
  @Operation(summary = "Clear log file content", operationId = "systemlog:instance:file:clear")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Log file content cleared successfully")})
  @PostMapping("/instance/{id}/file/{name}")
  public ApiLocaleResult<?> fileClear(
      @Parameter(name = "id", description = "Service instance unique identifier", required = true) @PathVariable("id") String instanceId,
      @Parameter(name = "name", description = "Log file name to clear", required = true) @PathVariable("name") String fileName) {
