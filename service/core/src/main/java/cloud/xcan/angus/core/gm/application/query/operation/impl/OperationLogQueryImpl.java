 ...
 * </p>
 * <p>
 * Manages operation log retrieval, filtering, and user information association. Provides
 * comprehensive operation log querying with full-text search and summary support.
 * </p>
 * <p>
 * Supports operation log listing with client filtering and user information enrichment for
 * comprehensive operation log management.
 * </p>
 */
@Slf4j
...
public class OperationLogQueryImpl implements OperationLogQuery {
   ...
   * </p>
   * <p>
   * Supports full-text search and specification-based filtering. Applies client filtering for
   * tenant clients and enriches results with user information.
   * </p>
   */
  @Override
