...
public class SmsInnerRest {
  ...
  @Operation(summary = "Send SMS message through internal API", operationId = "sms:send:inner")
  @ApiResponses(value = {
  ...
  @Operation(summary = "Validate SMS verification code through internal API", operationId = "sms:verificationCode:check:inner")
  @ApiResponses(value = {
