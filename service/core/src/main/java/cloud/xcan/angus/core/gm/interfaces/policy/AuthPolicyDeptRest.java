...
@Tag(name = "AuthorizationPolicyDepartment", description = "Provides a unified entry for querying the relationship between departments and authorization policies")
@Validated
@RestController
