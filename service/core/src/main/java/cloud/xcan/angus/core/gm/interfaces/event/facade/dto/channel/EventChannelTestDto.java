...
@Setter
@Getter
public class EventChannelTestDto implements Serializable {

  @NotNull
  @Schema(description = "Event notification channel type for testing", example = "WECHAT", requiredMode = RequiredMode.REQUIRED)
  ...
  @Schema(description = "Event channel endpoint URL for testing. For EMAIL type, multiple addresses separated by commas",
