...
public class AppFuncReplaceDto {

  @Schema(description = "Application function identifier to replace")
  private Long id;

  @NotBlank
  @Length(max = MAX_CODE_LENGTH)
  @Schema(description = "Application function unique code identifier", example = "script:add", requiredMode = RequiredMode.REQUIRED)
  private String code;

  @NotBlank
  @Length(max = MAX_NAME_LENGTH)
  @Schema(description = "Application function display name", example = "Add angus script", requiredMode = RequiredMode.REQUIRED)
  private String name;

  @NotBlank
  @Length(max = MAX_APP_FUNC_SHORT_NAME_LENGTH)
  @Schema(description = "Application function short display name for UI", example = "Add script", requiredMode = RequiredMode.REQUIRED)
  ...
  @Schema(description = "Function icon URL for UI display", example = "http://dev-files.xcan.cloud/storage/api/v1/file/Menu01.icon", requiredMode = RequiredMode.REQUIRED)
  private String icon;

  // Modification not allowed, add is allowed
  @Schema(description = "Application function type (cannot be modified after creation)")
  ...
  @NotNull
  @Schema(description = "Enable authorization control for this function", example = "true")
