...
public class TOUserRoleRest {
  ...
  @Operation(description = "Authorized the operation roles to user.", operationId = "to:user:role:auth")
  @ApiResponses(value = {
  ...
  @Operation(description = "Delete the operation roles of user.", operationId = "to:user:role:delete")
  ...
  @Operation(description = "Authorized to operation role to users.", operationId = "to:role:user:auth")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Authorize successful"),
      @ApiResponse(responseCode = "404", description = "Resource not found")
  })
  ...
  @Operation(description = "Delete the user operation roles.", operationId = "to:role:user:delete")
  @ResponseStatus(HttpStatus.NO_CONTENT)
  @ApiResponses(value = {
      @ApiResponse(responseCode = "204", description = "Deleted successfully")})
