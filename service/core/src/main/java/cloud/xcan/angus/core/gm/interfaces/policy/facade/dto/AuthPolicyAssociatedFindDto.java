...
public class AuthPolicyAssociatedFindDto extends PageQuery {
  ...
  @Schema(description = "Whether to ignore authorization organization information")
  private Boolean ignoreAuthOrg = false;

  @Schema(description = "Whether administrator has full association privileges")
  private Boolean adminFullAssociated = false;
