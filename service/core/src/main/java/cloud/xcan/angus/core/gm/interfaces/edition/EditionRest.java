...
public class EditionRest {
  ...
  @Operation(description = "Query the installed and authorized edition of product.", operationId = "edition:installed:detail")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the latest and upgradeable edition of product.", operationId = "edition:upgradeable:detail")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
