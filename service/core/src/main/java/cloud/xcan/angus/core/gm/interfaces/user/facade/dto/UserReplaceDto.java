...
public class UserReplaceDto implements Serializable {
  ...
  @Schema(description = "Unique username for system identification (empty during signup)", maxLength = MAX_NAME_LENGTH)
  ...
  @Length(max = MAX_EMAIL_LENGTH)
  @Schema(description = "Account used during registration (email or mobile number, cannot be modified)",
