...
public class EmailServerRest {
  ...
  @Operation(description = "Add email server.", operationId = "email:server:add")
  ...
  @Operation(description = "Update email server.", operationId = "email:server:update")
  ...
  @Operation(description = "Replace email server.", operationId = "email:server:replace")
  ...
  @Operation(description = "Delete email server.", operationId = "email:server:delete")
  ...
  @Operation(description = "Enable or disable email server.", operationId = "email:server:enabled")
  @ApiResponses(value = {
  ...
  @Operation(description = "Check the enabled email server.", operationId = "email:server:check")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the detail of email server.", operationId = "email:server:detail")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
  ...
  @Operation(description = "Query the list of email server.", operationId = "email:server:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping
