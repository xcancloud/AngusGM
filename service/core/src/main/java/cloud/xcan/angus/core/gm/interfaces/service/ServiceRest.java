...
public class ServiceRest {
  ...
  @Operation(description = "Add services.", operationId = "service:add")
  @ApiResponses(value = {
  ...
  @OperationClient
  @PreAuthorize("@PPS.isOpClient()")
  @Operation(description = "Update services.", operationId = "service:update")
  @ApiResponses(value = {
  ...
  @OperationClient
  @PreAuthorize("@PPS.isOpClient()")
  @Operation(description = "Replace services.", operationId = "service:replace")
  @ApiResponses(value = {
  ...
  @OperationClient
  @PreAuthorize("@PPS.isOpClient()")
  @Operation(description = "Delete services.", operationId = "service:delete")
  ...
  @OperationClient
  @PreAuthorize("@PPS.isOpClient()")
  @Operation(description = "Enable or disable services.", operationId = "service:enabled")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the detail of service.", operationId = "service:detail")
  @ApiResponses(value = {
  ...
  @Operation(description = "Query the list of service.", operationId = "service:list")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping
  ...
  @Operation(description = "Fulltext search the list of service.", operationId = "service:search")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
  @GetMapping("/search")
  ...
  @Operation(description = "Query the all resources of service.", operationId = "service:resource:all")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully"),
      @ApiResponse(responseCode = "404", description = "Resource not found")
  })
  ...
  @Operation(description = "Query the all apis of service or resource.", operationId = "service:resource:api:all")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "Retrieved successfully")})
