...
public class ApiReplaceDto {
  ...
  @Id
  @Schema(description = "API identifier to replace. Required when modifying existing API, creates new API when empty")
  private Long id;

  @Schema(description = "API service identifier. Note: Modification is not allowed after creation")
