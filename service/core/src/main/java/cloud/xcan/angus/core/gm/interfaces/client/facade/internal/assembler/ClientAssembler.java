...
public class ClientAssembler {
  ...
  public static CustomOAuth2RegisteredClient addDtoToDomain(ClientAddDto dto) {
  ...
  public static CustomOAuth2RegisteredClient replaceDtoToDomain(ClientReplaceDto dto) {
    return CustomOAuth2RegisteredClient
        .with(dto.getId())
  ...
  public static CustomOAuth2RegisteredClient updateDtoToDomain(ClientUpdateDto dto) {
    return CustomOAuth2RegisteredClient
        .with(dto.getId())
        .clientSecret(dto.getClientSecret())
        .clientSecretExpiresAt(asInstant(dto.getClientSecretExpiresAt()))
  ...
  public static ClientDetailVo toDetailVo(CustomOAuth2RegisteredClient client) {
    return new ClientDetailVo().setId(client.getId())
