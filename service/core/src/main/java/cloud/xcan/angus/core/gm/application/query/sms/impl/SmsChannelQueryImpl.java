 ...
 * </p>
 * <p>
 * Manages SMS channel retrieval, validation, and status checking. Provides comprehensive SMS
 * channel querying with enabled status support.
 * </p>
 * <p>
 * Supports SMS channel detail retrieval, paginated listing, and enabled channel queries for
 * comprehensive SMS channel administration.
 * </p>
 */
...
public class SmsChannelQueryImpl implements SmsChannelQuery {
   ...
   * </p>
   * <p>
   * Fetches complete SMS channel record with existence validation. Throws ResourceNotFound
   * exception if SMS channel does not exist.
   * </p>
   */
  @Override
   ...
   * </p>
   * <p>
   * Supports specification-based filtering and pagination. Returns paginated SMS channel results.
   * </p>
   */
  @Override
   ...
   * </p>
   * <p>
   * Returns the first enabled SMS channel found. Returns null if no enabled SMS channel exists.
   * </p>
   */
  @Override
