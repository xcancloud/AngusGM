...
import static cloud.xcan.angus.core.gm.interfaces.authentication.facade.internal.assembler.AuthClientAssembler.addDtoToDomain;
import static cloud.xcan.angus.core.gm.interfaces.authentication.facade.internal.assembler.AuthClientAssembler.replaceDtoToDomain;
import static cloud.xcan.angus.core.gm.interfaces.authentication.facade.internal.assembler.AuthClientAssembler.toDetailVo;
import static cloud.xcan.angus.core.gm.interfaces.authentication.facade.internal.assembler.AuthClientAssembler.updateDtoToDomain;
...
import cloud.xcan.angus.core.gm.application.cmd.authentication.AuthClientCmd;
import cloud.xcan.angus.core.gm.application.query.authentication.AuthClientQuery;
import cloud.xcan.angus.core.gm.interfaces.authentication.facade.AuthClientFacade;
import cloud.xcan.angus.core.gm.interfaces.authentication.facade.dto.AuthClientFindDto;
import cloud.xcan.angus.core.gm.interfaces.authentication.facade.internal.assembler.AuthClientAssembler;
