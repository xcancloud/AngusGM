import { GM, PUB_GM, ESS, STORAGE } from '@xcan-angus/tools';
...
export const edition = new Edition(GM);
...
export const storage = new Storage(STORAGE);
export const appopen = new Appopen(GM);
