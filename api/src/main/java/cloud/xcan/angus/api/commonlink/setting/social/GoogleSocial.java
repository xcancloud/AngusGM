...
@AllArgsConstructor
@NoArgsConstructor
public class GoogleSocial extends ValueObjectSupport<GoogleSocial> {
  ...
  @Override
  public GoogleSocial copy() {
    return new GoogleSocial(this.appId, this.secret, this.callback, this.codeUrl,
